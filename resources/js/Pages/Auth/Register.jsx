...
import '../../../css/register/register.css'; // Using the direct relative path to avoid Vite alias issues
            ...
            <PageWrapper>
                <GlassCard className="register-card">
                    <div className="register-header">
                        ...
                        <p className="register-subtitle">Join Clinicare to manage your health and appointments.</p>
                    </div>
                    ...
                    <div className="register-footer">
                        <p className="footer-text">
                            Already have an account? <Link href={route('login')} className="signin-link">Sign in</Link>
                        </p>
                    </div>
                </GlassCard>
            </PageWrapper>
